            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    <div className="flex-shrink-0 flex items-center">
                        <a href="#" className="font-bold text-xl text-black tracking-tight">
                            Amar El Farouki
                        </a>
                    </div>
                        ...
                        <div className="ml-10 flex items-baseline space-x-4">
                            {navLinks.map((link) => (
                                <a
                                    key={link.name}
                                    href={link.href}
                                    className="text-gray-600 hover:text-black px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200"
                                >
                                    {link.name}
                                </a>
                            ))}
                            <a
                                href="/CV_AMAR.pdf"
                                download="CV_AMAR.pdf"
                                className="bg-black text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-800 transition-transform transform hover:-translate-y-0.5 shadow-md flex items-center gap-2"
                            >
                                <span>CV</span>
                ...
                <div className="md:hidden" id="mobile-menu">
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white shadow-lg border-t border-gray-100">
                        ...
                        <a
                            href="/CV_AMAR.pdf"
                            download="CV_AMAR.pdf"
                            className="text-black block px-3 py-2 rounded-md text-base font-medium font-bold"
                            onClick={() => setIsOpen(false)}
                        >
                            Télécharger CV
                        </a>
